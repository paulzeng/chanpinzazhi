...
public class GetByNavigateIdHttpRequest extends
	...
	public GetByNavigateIdHttpRequest(int msgWhat,Context context, Handler handler,
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			httpTranstation
					.call("http://eims.com.cn/GetByNavigateId", envelope);
