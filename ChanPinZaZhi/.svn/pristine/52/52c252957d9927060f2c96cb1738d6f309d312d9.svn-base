...
public class PostHttpRequest extends AsyncTask<String, Integer, String> implements SoapDataImpl {
	...
	public PostHttpRequest(Context context, Handler handler,SoapObject rpc,
			boolean isListViewOnScroll){
		super();
		this.context = context;
		this.handler = handler;
		this.rpc = rpc;
		this.isListViewOnScroll = isListViewOnScroll;
		this.wsdl = ConfigManager.getConfigs(context, "url_wsdl");
	}
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			// httpTranstation.call(SoapConstants.NAMESAPCE
			// + SoapConstants.GetByTableId, envelope);
			httpTranstation.call("http://eims.com.cn/Post", envelope);
