...
public class ViewFlowAdapter extends BaseAdapter {
	...
	private  String[] images = { "assets://logo01.png", "assets://logo02.png", "assets://logo03.png" };
...
public void setRes(String[] _images){
	if(_images==null||_images.length==0){
		return;
	}
	images = _images;
	L.i("------############setRes_images="+_images);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		L.i("############position="+position+"::images[position % images.length]"+images[position % images.length]);;
		return convertView;
	}
