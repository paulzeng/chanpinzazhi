...
public class GetByTableIdHttpRequest extends AsyncTask<String, Integer, String>
	...
	public GetByTableIdHttpRequest(int msgWhat,Context context, Handler handler,SoapObject rpc,
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			httpTranstation.call("http://eims.com.cn/GetByTableId", envelope);
