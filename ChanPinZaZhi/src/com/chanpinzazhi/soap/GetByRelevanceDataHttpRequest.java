...
public class GetByRelevanceDataHttpRequest extends
		AsyncTask<String, Integer, String> implements SoapDataImpl {
	...
	public GetByRelevanceDataHttpRequest(int msgWhat, Context context,
			Handler handler, SoapObject rpc, boolean isListViewOnScroll) {
		super();
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			httpTranstation.call(
					"http://eims.com.cn/GetContentWidthRelevantData", envelope);
