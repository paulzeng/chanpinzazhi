...
public class GetNewContentsRequest extends AsyncTask<String, Integer, String>
	...
	public GetNewContentsRequest(int msgWhat, Service context, Handler handler,
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			httpTranstation.call("http://eims.com.cn/GetNewContents", envelope); 
