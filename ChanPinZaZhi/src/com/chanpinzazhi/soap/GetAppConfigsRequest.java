...
public class GetAppConfigsRequest extends AsyncTask<String, Integer, String>
	...
	public GetAppConfigsRequest(int msgWhat, Context context, Handler handler,
		...
		this.wsdl = ConfigManager.getConfigs(context, "cig_wsdl");//url_wsdl
	}
	...
	public String sendSoap(SoapObject rpc, Handler handler) {
		...
		try {
			...
			httpTranstation.call("http://eims.com.cn/GetAPPConfig", envelope); 
			Log.d(null, "#######################envelope.getResponse()="+envelope.getResponse());
